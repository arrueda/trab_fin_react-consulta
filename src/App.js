...
import Comerciales from "./Compounents/Routes/Comerciales/Comerciales";
import ComercialesId from "./Compounents/Routes/Comerciales/ComercialesId";
    ...
    <div className="App">
     <BrowserRouter>
        ...
        <Routes>
          ...
          <Route exact path="/comerciales/:id" element={ <ComercialesId id='Qo7ESdaalSLEAI6hvxEg' /> } />
